...
//Have divider return an Array with the first item in the array being the evens array (all the even values from nums) and the second item in the Array being the odds array(all the odd values from nums).
  ...
  function divider(nums, evens, odds) {
    ...
    for (var i = 0; i < nums.length; i++) {
      if (nums[i] % 2 === 0) {
        evenspush.push(nums[i]);
      } else {
        oddspush.push(nums[i]);
      }
    } evensAndOdds.push(evenspush);
      evensAndOdds.push(oddspush);
      return evensAndOdds;
  }
...
//Write a function called reverse that takes a given str as it's only argument and returns that string after it's been reversed
  ...
  function reverse(str) {
    var splinter = str.split('');
    splinter = splinter.reverse();
    splinter = splinter.join('');
    return splinter;
  }
...
// alert(removeItem(myGroceryList, 'chips')); // --> ['pizza', 'hotpockets', 'MtnDew', 'corndogs'];
// alert(addItem(myGroceryList, 'Jerky')); // --> ['pizza', 'hotpockets', 'MtnDew', 'corndogs', 'Jerky'];
...
//Write a function called 'longer' that is given arr1 and arr2 as it's only arguments. Return the array which is longest.
  ...
  function longer(arr1, arr2) {
    if (arr1.length > arr2.length) {
      ...
      return "arr1 & arr2 are the same legnth"
    }
  }
...
Loop through your devMountainEmployees until you find cahlan, then remove him from the array.*/
 ...
 function removeEmployee() {
  for (var i = 0; i < devMountainEmployees; i++) {
...
var user1 = {
  ...
  var user2 = {
    name: 'Cannon Collins',
    email: 'Cannon.j.collins@gmail.com',
    password: 'yadayada',
    username: 'CC'
  };
